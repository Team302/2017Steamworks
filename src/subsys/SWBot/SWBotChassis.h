...
#ifndef SRC_SUBSYS_SWBOT_SWBOTCHASSIS_H_
#define SRC_SUBSYS_SWBOT_SWBOTCHASSIS_H_
...
class SWBotChassis: public IChassis
{
private:
	// Drive Motors
...
public:
	...
	SWBotChassis();				//constructor
	virtual ~SWBotChassis() = default;		//destructor

};

} /* namespace Team302 */

#endif /* SRC_SUBSYS_SWBOT_SWBOTCHASSIS_H_ */
